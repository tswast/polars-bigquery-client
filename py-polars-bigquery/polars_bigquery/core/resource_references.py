# Branched from
# https://github.com/googleapis/python-bigquery-pandas/blob/5c339589b07687bc6eddb95d84806dc80dbd49f4/pandas_gbq/core/resource_references.py
...
def parse_table_id(table_id: str) -> Union[BigLakeTableId, BigQueryTableId]:
    ...
    if legacy_project_domain:
        project = legacy_project_domain + project
